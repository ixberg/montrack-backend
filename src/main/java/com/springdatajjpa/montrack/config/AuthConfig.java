...
import com.springdatajjpa.montrack.auth.service.impl.UserDetailServicesImpl;
...
public class AuthConfig {
    ...
    private UserDetailServicesImpl userDetailsServices;

    public AuthConfig(RsaConfiguration rsaConfiguration, UserDetailServicesImpl userDetailsServices) {
